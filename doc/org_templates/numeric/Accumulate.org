...
#+INCLUDE: ../../../spec/acc_def_naive.ads :src ada :lines "7-18"

**** Specification of Accumulate

With the given predicates we can write a specification for ~Accumulate~:

#+INCLUDE: ../../../numeric/accumulate_naive.ads :src ada :lines "7-10"
...
#+INCLUDE: ../../../numeric/accumulate_naive.adb :src ada :lines "4-17"
...
#+INCLUDE: ../../../spec/overflow.ads :src ada :lines "7-12"
...
#+INCLUDE: ../../../spec/acc_def_p.ads :src ada :lines "11-34"
...
#+INCLUDE: ../../../numeric/accumulate_p.ads :src ada :lines "7-10"
...
#+INCLUDE: ../../../numeric/accumulate_p.adb :src ada :lines "4-16"
