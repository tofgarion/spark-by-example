...
*** The Multiply_No_Overflow predicate
   ...
   #+INCLUDE: ../../../spec/overflow.ads :src ada :lines "19-23"

   And its implementation is:
   
   #+INCLUDE: ../../../spec/overflow.adb :src ada :lines "6-25"
...
*** The Inner_Prod_Def_Rec function
    ...
    #+INCLUDE: ../../../spec/inner_prod_def_p.ads :src ada :lines "7-28"
...
*** The Inner_Prod_Def function
    ...
    #+INCLUDE: ../../../spec/inner_prod_def_p.ads :src ada :lines "29-37"

** Specification of ~Inner_Product~

   The specification of ~Inner_Product~ is the following:

   #+INCLUDE:../../../numeric/inner_product_p.ads :src ada :lines "7-13"
...
** Implementation of ~Inner_Product~
   ...
   #+INCLUDE: ../../../numeric/inner_product_p.adb :src ada :lines "3-16"
