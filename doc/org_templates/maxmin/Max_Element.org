...
*** Implementation of Max_Element
    ...
    #+INCLUDE: "../../../maxmin/max_element_wo_ghost_p.adb" :src ada :range-begin "function Max_Element" :range-end "End Max_Element;" :lines "4-28"
...
*** Specification of Max_Element
    ...
    #+INCLUDE: "../../../maxmin/max_element_p.ads" :src ada :range-begin "function Max_Element_With_Ghost" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :lines "7-18"

*** Implementation of Max_Element

     The implementation is almost the same as before:

     #+INCLUDE: "../../../maxmin/max_element_p.adb" :src ada :range-begin "function Max_Element_With_Ghost" :range-end "End Max_Element_With_Ghost;" :lines "4-32"
