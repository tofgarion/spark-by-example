...
**** Implementation of Partial_Sort_Aux
     ...
     #+INCLUDE: "../../../sorting/partial_sort_p.adb" :src ada :range-begin "procedure Partial_Sort_Aux" :range-end "End Partial_Sort_Aux;" :lines "11-46"
...
*** Implementation of ~Partial_Sort~
    ...
    #+INCLUDE: "../../../sorting/partial_sort_p.adb" :src ada :range-begin "procedure Partial_Sort " :range-end "End Partial_Sort;" :lines "47-94"
