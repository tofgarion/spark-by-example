...
#+INCLUDE: ../../../heap/push_heap_p.ads :src ada :lines "8-19"
...
#+INCLUDE: ../../../spec/multiset_predicates.ads :src ada :lines "28-40"
...
#+INCLUDE: ../../../spec/multiset_predicates.ads :src ada :lines "14-21"
...
#+INCLUDE: ../../../heap/push_heap_p.adb :src ada :lines "3-25"
...
#+INCLUDE: ../../../lemmas/push_heap_lemmas.ads :src ada :lines "30-45"
...
#+INCLUDE: ../../../lemmas/push_heap_lemmas.adb :src ada :lines "17-28"
...
#+INCLUDE: ../../../heap/push_heap_p.adb :src ada :lines "26-67"
...
**** The No_Changes lemma
     ...
     #+INCLUDE: ../../../lemmas/push_heap_lemmas.ads :src ada :lines "10-29"

     Its implementation is:
     #+INCLUDE: ../../../lemmas/push_heap_lemmas.adb :src ada :lines "4-16"
...
**** The Make_Prove_Loop lemma
     ...
     #+INCLUDE: ../../../lemmas/push_heap_lemmas.ads :src ada :lines "46-66"
	
     Its implementation is:
     #+INCLUDE: ../../../lemmas/push_heap_lemmas.adb :src ada :lines "29-48"
...
**** Implementation of Epilogue
     ...
     #+INCLUDE: ../../../heap/push_heap_p.adb :src ada :lines "68-79"
...
**** The Make_Prove_Epilogue lemma
     ...
     #+INCLUDE: ../../../lemmas/push_heap_lemmas.ads :src ada :lines "67-84"
     
     Its implementation is:
     #+INCLUDE: ../../../lemmas/push_heap_lemmas.adb :src ada :lines "49-63"
