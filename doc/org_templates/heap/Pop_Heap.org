...
**** The Maximum_Heap_Child function
     ...
     #+INCLUDE: "../../../heap/pop_heap_p.adb" :src ada :range-begin "function Maximum_Heap_Child" :range-end "End Maximum_Heap_Child;" :lines "5-26"
...
*** Implementation of Pop_Heap
    ...
    #+INCLUDE: "../../../heap/pop_heap_p_wo_lines.adb" :src ada :range-begin "procedure Pop_Heap" :range-end "End Pop_Heap;" :lines "27-69"
    ...
    #+INCLUDE: "../../../heap/pop_heap_p.adb" :src ada :range-begin "procedure Pop_Heap" :range-end "End Pop_Heap;" :lines "27-176"
