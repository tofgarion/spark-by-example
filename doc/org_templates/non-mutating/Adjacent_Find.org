...
*** The predicate Has_Equal_Neighbors
    ...
    #+INCLUDE: "../../../spec/has_equal_neighbors_p.ads" :range-begin "function Has_Equal_Neighbors" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :src ada :lines "9-13"
...
*** Specification of Adjacent_Find
    ...
    #+INCLUDE: "../../../non-mutating/adjacent_find_p.ads" :range-begin "function Adjacent_Find" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :src ada :lines "8-18"
...
*** Implementation of Adjacent_Find
    ...
    #+INCLUDE: "../../../non-mutating/adjacent_find_p.adb" :range-begin "function Adjacent_Find" :range-end "end Adjacent_Find;" :src ada :lines "6-27"
