...
*** The predicate Occ
    ...
    #+INCLUDE: "../../../spec/occ_def_p.ads" :range-begin "function Remove_Last" :range-end "Occ_Def);" :src ada :lines "6-20"
    ...
    #+INCLUDE: "../../../spec/occ_p.ads" :range-begin "function Occ" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :src ada :lines "7-9"
...
*** Specification of Count
    ...
    #+INCLUDE: "../../../non-mutating/count_p.ads" :range-begin "function Count" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :src ada :lines "7-12"
...
*** Implementation of Count
    ...
    #+INCLUDE: "../../../non-mutating/count_p.adb" :range-begin "function Count" :range-end "end Count;" :src ada :lines "6-20"
