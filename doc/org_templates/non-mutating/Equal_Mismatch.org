...
*** The predicate Equal_Ranges
    ...
    #+INCLUDE: "../../../spec/equal_ranges_p.ads" :lines "12-18"
...
*** Specification of Equal
    ...
    #+INCLUDE: "../../../non-mutating/equal_p.ads" :src ada :range-begin "function Equal" range-begin "function Equal_Ranges\\n" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :lines "9-13"

*** Implementation of Equal

    ~Equal~ is easily implemented using ~Mismatch~:

    #+INCLUDE: "../../../non-mutating/equal_p.adb" :src ada :range-begin "function Equal" :range-end "end Equal;" :lines "7-11"
...
*** A "reversed" specification and implementation of Equal
    ...
    #+INCLUDE: "../../../non-mutating/equal_rev_p.ads" :src ada :range-begin "function Equal" range-begin "function Equal_Ranges\\n" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :lines "10-16"
