...
*** The predicate Has_Subrange_In_Postfix
    ...
    #+INCLUDE: "../../../spec/has_subrange_p.ads" :range-begin "function Has_Subrange_In_Postfix" range-begin "function Equal_Ranges\\n" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :src ada :lines "48-58"
    ...
    #+INCLUDE: "../../../spec/has_subrange_p.ads" :range-begin "function Has_Subrange_In_Prefix" range-begin "function Equal_Ranges\\n" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :src ada :lines "20-28"
...
*** Specification of Find_End
    ...
    #+INCLUDE: "../../../non-mutating/find_end_p.ads" :range-begin "function Find_End" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :src ada :lines "9-23"
...
*** Implementation of Find_End
    ...
    #+INCLUDE: "../../../non-mutating/find_end_p.adb" :range-begin "function Find_End" :range-end "end Find_End;" :src ada :lines "6-39"
