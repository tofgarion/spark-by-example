...
** The Find algorithm
   ...
   #+INCLUDE: "../../../spec/types.ads" :range-begin "type T is new Integer;" :range-end "(Positive range <>) of T" :src ada :lines "5-8"
...
**** Specification of Find
     ...
     #+INCLUDE: "../../../non-mutating/naive_find_p.ads" :range-begin "function Find" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :src ada :lines "8-16"
     ...
     - we can divide the specification of ~Find~ into two
       ...
       #+INCLUDE: "../../../non-mutating/naive_find_contract_pb.ads" :range-begin "function Find" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :src ada :lines "8-16"
...
**** Implementation of Find
     ...
     #+INCLUDE: "../../../non-mutating/naive_find_p.adb" :range-begin "function Find" :range-end "end Find;" :src ada :lines "6-18"
...
**** The predicate Has_Value
     ...
     #+INCLUDE: "../../../spec/has_value_p.ads" :range-begin "function Has_Value" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :src ada :lines "9-13"
     ...
     #+INCLUDE: "../../../spec/types.ads" :range-begin "type Option" :range-end "end record;" :src ada :lines "20-28"
...
**** Specification of Find
     ...
     #+INCLUDE: "../../../non-mutating/find_p.ads" :range-begin "function Find" :range-end "\s-*(\([^()]*?\(?:\n[^()]*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :src ada :lines "9-17"
...
**** Implementation of Find
     ...
     #+INCLUDE: "../../../non-mutating/find_p.adb" :range-begin "function Find" :range-end "end Find;" :src ada :lines "6-22"
