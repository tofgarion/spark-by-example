...
**** Implementation of Search
     ...
     #+INCLUDE: "../../../non-mutating/search_with_ghost_p.adb" :src ada :range-begin "function Search" :range-end "end Search;" :lines "6-27"
...
**** A new definition for Has_Subrange
     ...
     1. first, a function ~Equal_Subrange~ is defined. This function
        ...
        #+INCLUDE: "../../../spec/has_subrange_p.ads" :src ada :range-begin "function Equal_Subrange" :range-end "\s-*(\(.*?\(?:\n.*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :lines "11-19"
     ...
     2. a function ~Has_Subrange_In_Prefix~ is then defined. It
        ...
        #+INCLUDE: "../../../spec/has_subrange_p.ads" :src ada :range-begin "Has_Subrange_In_Prefix" :range-end "\s-*(\(.*?\(?:\n.*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :lines "20-28"

     3. finally ~Has_Subrange~ is defined using
        ~Has_Subrange_In_Prefix~ and does not contain directly
        quantifiers or slices.

        #+INCLUDE: "../../../spec/has_subrange_p.ads" :src ada :range-begin "Has_Subrange" :range-end "\s-*(\(.*?\(?:\n.*\)*?\)*)\s-*\([^;]*?\(?:\n[^;]*\)*?\)*;" :lines "1-19"
...
**** Implementation of Search
     ...
     #+INCLUDE: "../../../non-mutating/search_p.adb" :src ada :range-begin "function Search" :range-end "end Search;" :lines "6-26"
