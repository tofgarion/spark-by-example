      ...
      Contract_Cases => (A'Length = 0 => not Search_Equal_Range2'Result.Exists,
       A'Length > 0 =>
         ...
         (if
          ...
          then
            Constant_Range
              (A, V, Search_Equal_Range2'Result.Lower,
               Search_Equal_Range2'Result.Upper - 1))
         and then Strict_Lower_Bound
           (A (Search_Equal_Range2'Result.Upper .. A'Last), V));
